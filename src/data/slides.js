...
const T = [
  ...
  { t: 'full',   img: true, arrow: 'Tu as pris cette photo parce que t\'étais à côté de chez moi hihi' },
  { t: 'cards',  v: 'pol4',    imgsCount: 4,   lbls: ['Janvier', 'Été', 'Automne', 'Hiver'], recap: 'Un récap de toute ta vie, et ton futur aussi peut-être hihi', rounded: true },
  ...
  { t: 'framed', img: true, cap: 'Ohlolo quelle queen ma beauté',             w: 235, h: 375 },
  { t: 'quote',  q: 'Ta grâce est la plus belle\ndes œuvres d\'art.', sub: 'Je t\'aime · Toujours' },
  { t: 'full',   img: true, cap: 'J\'ai zoomé pour voir si t\'es vraiment queen, pas trop sérieuse mais t\'es la queen de mon cœur (mais pas de BK chip)' },
  { t: 'cards',  v: 'rib3',    imgsCount: 3,   lbls: ['Rires', 'Larmes', 'Victoires'], overlay: 'Tu vois je le dis et je le redis, t\'es ma queen' },
  { t: 'diag',   q: 'Chaque étoile\ndans le ciel\nte ressemble.',   sub: 'Mon étoile · Ma nuit',    al: 'r' },
  ...
  { t: 'cards',  v: 'col3',   imgsCount: 3,   lbls: ['Mon amour', 'Douceur', 'Éternité'], overlay: 'Meilleure soirée passée avec toi, hâte d\'en passer d\'autres' },
